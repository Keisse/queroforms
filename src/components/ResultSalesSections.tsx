...
export function ResultBookOffer(){
  return <div className="offer-card qf-book-offer-hero">
    ...
    <div className="offer-copy">
      ...
      <a className="primary big qf-sales-primary" href={CHECKOUT_URL} target="_blank" rel="noreferrer">QUERO MEU EXEMPLAR</a>
      <a className="secondary big qf-price-link" href={DETAILS_URL} target="_blank" rel="noreferrer"><span className="qf-old-price">R$67</span> <strong>por R$47</strong></a>
    </div>
  </div>;
}

export default function ResultSalesSections(){
  return <>
    ...
    <section className="qf-sales-section qf-sales-author">
    ...
    <section className="qf-sales-section qf-sales-final">
      ...
      <a className="primary big qf-sales-primary qf-sales-final-button" href={CHECKOUT_URL} target="_blank" rel="noreferrer">Quero meu exemplar por R$47</a>
    </section>
  </>;
}
