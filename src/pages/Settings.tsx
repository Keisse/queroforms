...
export default function Settings(){
  ...
  return <>
    <header className="page-head"><div><div className="crumb">QueroForms › Workspace</div><h1>Configurações</h1></div></header>
    <section className="settings-grid">
      ...
      <div className="settings-card"><div className="settings-icon"><PlugZap/></div><div><h2>CRM</h2><p>O CRM poderá consumir os dados do Supabase depois, sem depender do frontend do QueroForms.</p><span className="conn pending">Próxima etapa</span></div></div>
    </section>
  </>
}
